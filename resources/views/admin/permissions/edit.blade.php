                    ...
                    <div class="card-body">
                        ...
                        <form  action="{{ route('permissions.update', $permission->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $permission->name }}"  type="text" class="form-control"  @error('name') is-invalid @enderror placeholder="Permission Name" name="name" value="{{ old('name') }}" required autocomplete="name">
                                @error('name')
