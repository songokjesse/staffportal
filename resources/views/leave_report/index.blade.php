...
{{--                        <a href="{{route('leave_calendar')}}" class="btn btn-primary btn-sm"> <i class="bi bi-calendar"></i> Calendar View</a>--}}
                        <a href="{{route('individual_report')}}" class="btn btn-primary btn-sm"> <i class="bi bi-bar-chart"></i> Individual Report</a>
                                        ...
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{$on_leave}}</div>
                                                </div>
                                                <div class="col-auto">
                                        ...
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{$leave_applications}}</div>
                                                </div>
                                                <div class="col-auto">
